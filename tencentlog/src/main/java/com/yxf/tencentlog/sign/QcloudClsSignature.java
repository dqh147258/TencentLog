package com.yxf.tencentlog.sign;
...
public class QcloudClsSignature {
    ...
    public static String buildSignature(String secretId, String secretKey, String method, String path,
        ...
        String signKey = encodeHex(HmacUtils.hmacSha1(secretKey, qKeyTimeStr));
        ...
        String hashFormatStr = encodeHex(DigestUtils.sha1(formatStr));
        ...
        String signature = encodeHex(HmacUtils.hmacSha1(signKey, stringToSign));
